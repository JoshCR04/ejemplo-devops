    ...
    <section class="flex justify-center items-center min-h-screen bg-gray-200"> 
        <div class="bg-white rounded-xl p-4 w-80 relative shadow-md"> 
            ...
            <div class="flex justify-end mt-4">
                ...
                <button id="joinBtn" class="bg-blue-600 text-white rounded-xl px-6 py-1 hover:bg-blue-700">${this.btn_unirse_grupo}</button>
            </div>
            <p id="mensaje" class="mt-4 text-green-600 font-medium hidden">Bienvenido</p>
        </div>
    </section>
    `;
